const items = [
  ...
  { heading: 'Do Crypto Ricks have any utility?', content: 'Once all Crypto Ricks have been minted, the team will be setting up a treasury with a portion of the funds to donate to charity. Crypto Ricks holders will get to vote on what charity those funds are donated to. We are also developing a PVP based game that will allow you to customize Ricks and Weapons to fight other Rick holders. This gets released once the first 3000 Ricks are minted!' },
