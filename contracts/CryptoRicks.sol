...
// File contracts/CryptoRicks.sol
...
contract CryptoRicks is Ownable, ERC721Enumerable, ERC721Burnable, ReentrancyGuard {
    ...
    uint256 public constant MAX_CRICKS = 10000;
    ...
    constructor() ERC721("Crypto Ricks", "CRICKS") {
        // reserveTokens(50);
    }
    ...
    function mint(uint256 _numBears) public payable {
        ...
        require(nextId + _numBears <= MAX_CRICKS, "Mint amount exceeds supply");
        require((msg.value >= MINT_FEE * _numBears && nextId + _numBears <= 10000) || (msg.value >= MINT_FEE * _numBears * 2), "Price not met");
